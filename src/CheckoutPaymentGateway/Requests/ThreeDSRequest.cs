...
namespace CheckoutPaymentGateway.Requests
{
    ...
    /// </summary>
    public class ThreeDSRequest : ThreeDSEnrollment
    {
        ///// <summary>
        ...
        //[DataMember(Name = "signature_valid")]
        ...
        //[DataMember(Name = "authentication_response")]
        ...
        //    return obj.GetType() == GetType() && Equals((ThreeDSRequest)obj);
        //}
        ...
        //public static bool operator ==(ThreeDSRequest left, ThreeDSRequest right)
        //{
